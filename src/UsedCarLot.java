...
public class UsedCarLot
{
    ...
    {
        if (idx1 < this.inventory.size() && idx2 < this.inventory.size()) {
            Car temp1 = this.inventory.get(idx1);
            Car temp2 = this.inventory.get(idx2);
            this.inventory.set(idx1,temp2);
            this.inventory.set(idx2,temp1);
        }
  ...
  */
    ...
    {
        this.inventory.add(indexToAdd,carToAdd);
    }
    ...
    {
        return this.inventory.remove(indexOfCarToSell);
    }
    ...
    {
        Car removed = this.inventory.remove(indexOfCarToSell);
        this.inventory.add(indexOfCarToSell,null);
        return removed;
    }
    ...
    {
        this.inventory.add(destinationIndex,this.inventory.remove(indexOfCarToMove));
    }
